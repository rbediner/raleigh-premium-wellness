...
const requiredDocumentRules = [
  ...
  },
  {
    ...
    requiredSnippets: [
      ...
      "smallest responsible qa gate",
      "full live-staging backend validation pack",
      "docs/qa/backend-qa-trigger-sop.md",
  ...
  {
    filePath: "docs/qa/backend-qa-trigger-sop.md",
    requiredSnippets: [
      "cheap routine qa",
      "targeted smoke qa",
      "full live-staging backend validation pack",
      "cost control and signal discipline",
